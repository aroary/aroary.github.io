...
generate.onclick = () => {
    ...
    if (url.value) generated.value += encodeURI(`webhook=${url.value}&`);
    if (username.value) generated.value += encodeURI(`username=${username.value}&`);
    if (pfp.value) generated.value += encodeURI(`avatar=${pfp.value}&`);
    if (content.value) generated.value += encodeURI(`content=${content.value}&`);
    if (embedTitle.value) generated.value += encodeURI(`title=${embedTitle.value}&`);
    if (embedURL.value) generated.value += encodeURI(`url=${embedURL.value}&`);
    if (embedColor.value) generated.value += encodeURI(`color=${embedColor.value}&`);
    if (embedDescription.value) generated.value += encodeURI(`description=${embedDescription.value}&`);
    if (embedFooter.value) generated.value += encodeURI(`footer=${embedFooter.value}&`);
    if (embedFooterIcon.value) generated.value += encodeURI(`footerIcon=${embedFooterIcon.value}&`);
    if (embedImage.value) generated.value += encodeURI(`image=${embedImage.value}&`);
    if (embedThumbnail.value) generated.value += encodeURI(`thumbnail=${embedThumbnail.value}&`);
